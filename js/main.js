...
//   function changeCharakter(){
//     users.forEach((item)=> {
//        let newphone=item.phone
//         let phoneSplit=newphone.split ("");
//         let countryCode =phoneSplit[0];

//         let newNumberLastIndex=phoneSplit[1].split("").length-2;
//         let changeCharakter=phoneSplit[1].slice(0,newNumberLastIndex).split("");
//         let newData=changeCharakter.map((item)=>item>=0?"*":item).join("");
//         let lastNumber=phoneSplit[1].slice(newNumberLastIndex)
        
//         let =item.phone = countryCode+ " " +newData +lastNumber;
...
// function telefonNomresiniTap(username, users) {
//     users.forEach(function(person) {
//       if (person.firstName === username) {
//         console.log("Telefon nömrəsi: " + person.phone);
//       }
//     });
//   }


//   telefonNomresiniTap("Addison", users);
  


// 3) dogum ili 1990 ci ilden yuxari olanlari secen function yaradin

// function dogumIli1990danYuxariOlanlariSec() {
//     for (var i = 0; i < users.length; i++) {
//       var birthYear = new Date(users[i].birthDate).getFullYear(); // Tarixdən ili əldə etmək
//       if (birthYear > 1990) {
...
//   dogumIli1990danYuxariOlanlariSec();
...
// function emailGmailIleBitmeli() {
//     users.forEach(function(person) {
//       if (!person.email.endsWith("@gmail.com")) {
//         var emailPart = person.email.split('@')[0]; // @ işarəsinə qədər olan hissə
//         person.email = emailPart + "@gmail.com"; // Yeni email
//       }
//     });
...
// function gozRenginiSay() {
//     var gozRengiSaylari = {};
  
//     users.forEach(function(person) {
//       var gozRengi = person.eyeColor;
//       if (gozRengiSaylari[gozRengi]) {
//         gozRengiSaylari[gozRengi]++;
//       } else {
//         gozRengiSaylari[gozRengi] = 1;
//       }
//     });
  
//     console.log("Hər göz rənginə görə insan sayı:", gozRengiSaylari);
//     return gozRengiSaylari;
//   }
